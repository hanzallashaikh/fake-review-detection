...
def create_features(text, rating, category):
    ...
    # FINAL FIX: Use text_vec, NOT text!
...
<style>
    ...
    .result {padding: 2rem; border-radius: 20px; text-align: center; font-size: 2.5rem; font-weight: bold; margin: 2rem 0;}
...
with col1:
    review = st.text_area("Enter Review Text", height=200, placeholder="Paste any review here...", key="review")
with col2:
...
with c1:
    if st.button("Genuine Example"):
        st.session_state.review = "Great product! Fast delivery and works perfectly. Highly recommend."
        st.rerun()
with c2:
