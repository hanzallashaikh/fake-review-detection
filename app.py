...
with c1:
    if st.button("Genuine Example"):
        st.session_state.review_input = "Great product! Fast delivery and works perfectly. Highly recommend."
        st.rerun()
with c2:
    if st.button("Fake Example"):
        st.session_state.review_input = "amazing best perfect love love love wow wow"
        st.rerun()
